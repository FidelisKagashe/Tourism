...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'tourismproject.pythonanywhere.com']
...
TIME_ZONE = 'Africa/Dar_es_Salaam'  # East Africa Time (EAT)
USE_I18N = True
USE_TZ = True
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'tanzania_tourism.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
